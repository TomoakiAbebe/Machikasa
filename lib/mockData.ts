...
export const mockSponsors: import('@/types').Sponsor[] = [
  {
    ...
    name: '福井コーヒー',
    nameEn: 'Fukui Coffee',
    logoUrl: '/Machikasa/sponsors/fukui-coffee.svg',
  ...
  },
  {
    ...
    logoUrl: '/Machikasa/sponsors/sabae-books.svg',
  ...
  },
  {
    ...
    logoUrl: '/Machikasa/sponsors/fukui-coop.svg',
  ...
  },
  {
    ...
    name: 'カフェ未来',
    nameEn: 'Cafe Mirai',
    logoUrl: '/Machikasa/sponsors/cafe-mirai.svg',
